    ...
    if (!diagnoses || diagnoses.length === 0) {
        return (
            <div className="text-center flex flex-col items-center justify-center h-full animate-fade-in">
                <span className="material-symbols-outlined text-7xl text-gray-300 mb-4">search_off</span>
                <h2 className="text-2xl sm:text-3xl font-bold text-primary-dark mb-2">No se encontraron diagnósticos claros</h2>
                <p className="text-gray-600 max-w-lg">
                    Basado en la información proporcionada, no se pudo determinar un diagnóstico preliminar con una probabilidad significativa. Le recomendamos encarecidamente que consulte a un profesional de la salud para una evaluación completa.
                </p>
            </div>
        );
    }
